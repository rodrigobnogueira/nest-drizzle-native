...
description: Tenant routing patterns for Drizzle clients in Nest applications.
---
...
The package should not hide dynamic tenant routing behind automatic switching.
