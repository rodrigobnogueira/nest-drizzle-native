...
| [`13-zod-openapi-bridge`](https://github.com/rodrigobnogueira/nest-drizzle-native/tree/main/sample/13-zod-openapi-bridge) | Drizzle-Zod validation with Swagger contracts | `npm run test --workspace nest-drizzle-native-sample-13-zod-openapi-bridge` |
