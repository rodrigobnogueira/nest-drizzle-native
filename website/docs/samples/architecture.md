...
See [`02-repositories`](https://github.com/rodrigobnogueira/nest-drizzle-native/tree/main/sample/02-repositories).
...
See [`05-transactions-cls`](https://github.com/rodrigobnogueira/nest-drizzle-native/tree/main/sample/05-transactions-cls).
...
See [`06-manual-transaction`](https://github.com/rodrigobnogueira/nest-drizzle-native/tree/main/sample/06-manual-transaction).
